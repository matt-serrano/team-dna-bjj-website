        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-tight">TEAM DNA BJJ</span>
              <span className="text-[10px] text-muted-foreground tracking-[0.3em]">IT'S IN OUR GENES</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Building confidence, discipline, and community through Brazilian Jiu-Jitsu.
            </p>
            <div className="flex gap-3">
              <a href="https://www.facebook.com/TEAMDNABJJ" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg hover:bg-accent transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/teamdnabjj/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg hover:bg-accent transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.youtube.com/@TeamDNABJJ" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg hover:bg-accent transition-colors">
